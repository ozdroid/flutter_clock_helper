...
class _ClockCustomizerState extends State<ClockCustomizer> {
  ...
  Widget _enumMenu<T>(
      String label, T value, List<T> items, ValueChanged onChanged) {
  ...
  Widget _textField(String currentValue, String label, ValueChanged onChanged) {
    return TextField(
      decoration: InputDecoration(
      ...
      child: Drawer(
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                _textField(_model.location, 'Location', (dynamic location) {
                  setState(() {
